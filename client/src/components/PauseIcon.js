...
const PauseIcon = memo(function PauseIcon(props) {
  const { onClickPause } = props;

  return (
    <svg className="icon-pause" onClick={onClickPause} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
